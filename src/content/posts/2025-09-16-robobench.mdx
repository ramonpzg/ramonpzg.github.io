...
The most basic metrics I wanted to measure per model at the beginning involved initialisation,
runtime performance, and resources used. After setting up the foundation, I moved on to add metrics for
